...
class TrainDepartureTest {
  ...
  void setTrainNumberPositiveTestForCorrectTrainNumber() {
    trainDepartureTest = new TrainDeparture(123, "Gjøvik", 12, "12:00");
  ...
  void setTrainNumberNegativeTestForIncorrectTrainNumber() {
    trainDepartureTest = new TrainDeparture(-5, "Gjøvik", 12, "12:00");
  ...
  void setDestinationNegativeTestForIncorrectDestination() {
    trainDepartureTest = new TrainDeparture(123, null, 12, "12:00");
  ...
  void setDepartureTimeNegativeTestForIncorrectDP() {
    trainDepartureTest = new TrainDeparture(123, "Gjøvik", 12, "10:L5");
  ...
  void setDepartureTimeNegativeTestForIncorrectDP2() {
    trainDepartureTest = new TrainDeparture(123, "Gjøvik", 12, "50:00");
  ...
  void setDepartureTimeNegativeTestForIncorrectDP3() {
    trainDepartureTest = new TrainDeparture(123, "Gjøvik", 12, "010:23");
